...
Обычно такие блокировки применяются владельцами — для ограничения притока нежелательной аудитории, либо представителями властей — для ограничения доступа к содержимому, запрещенному местным законодательством.
...
Теги, определюящие принадлежность сайта к широко известным и характерным сообществам.
