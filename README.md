...
Редакция «Навигатора» проводит опрос о состоянии и развитии бордосферы — ты можешь принять участие!

  - [Ссылка на опрос](https://tally.so/r/3jPop4)
  - [Подробности](./surveys/stateof-2024.md)
...
В отличие от [#cycle:readonly](#cyclereadonly), содержимое становится архивным намеренно, а не из-за технической неисправности.
...
Схема, представленная в проекте [ccd0/imageboards.json](https://github.com/ccd0/imageboards.json) — это стандарт де-факто в международной бордосфере.Каталог «Навигатора» доступен в двух версиях этой схемы:
  ...
  - [Только подходящие](./index.ccd0-compat.json) · [API endpoint](https://austrellum.github.io/navigator/index.ccd0-compat.json) — только подходящие сайты
...
Таким образом, подходящими будут считаться сайты, которые одновременно:
  ...
  2. Являются бордами, или опрелеляют себя около-бордами, т.е. имеют тег [#board](#serviceboard), или [#chat](#servicechat)
