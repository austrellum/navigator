...
Каталог «Навигатора» делится на разделы, каждый из которых соответствует этапу жизненного цикла сайта:
  ...
  1. «Живые» — тег [#live](#live)
  2. «Отмирающие» — тег [#ghost](#ghost)
  3. «Только чтение» — тег [#readonly](#readonly)
  4. «Заглушки» — тег [#stub](#stub)
  5. «Мертвые» — тег [#dead](#dead)
...
В большинстве случаев это означает, что сайт будет перемещен по жизненному циклу — например, от «живых» к «отмирающим».
