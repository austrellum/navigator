...
К сожалению, собрать все борды со всего интернета будет слишком сложно — список получится очень большим, и, скорее всего, он никогда не будет хоть сколько-нибудь актуальным.

### Как часто выходят новые редакции

Ориентировочный срок — раз в месяц, но это не строгое правило.

В период активной разработки возможны и более частые выпуски.
