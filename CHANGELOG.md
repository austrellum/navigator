...
Cоздан второй тред для «Навигатора» — [НАВИГАТОР БОРДОСФЕРЫ — 2024 (#2)](https://wc.12hp.ch/wc/res/2577.html). Тред предназначен для обратной связи.

## 2023-12-19

Первый тред обратной связи для «Навигатора» ([см. ниже](#2022-06-06)) перешел в бамплимит.
